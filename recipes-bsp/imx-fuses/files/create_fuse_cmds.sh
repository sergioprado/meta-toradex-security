...
create_fuse_cmds() {
    ...
    # command: the close is the final step of the documented flow, run only
    # once a signed image has booted without HAB/AHAB events, so every other
    # fuse write has to precede it.
